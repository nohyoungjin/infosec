...
str += '				<div id="gnb">'
str += '					<button class="btn_offcanvas_close" type="button">전체메뉴 닫기</button>'
str += '					<ul>'
str += '						<li>'
...
str += '									<dl>'
str += '										<dt>사업소개</dt>'
str += '										<dd>SK 인포섹의 다양한 사업을 <br>한눈에 확인할 수 있습니다.</dd>'
str += '									</dl>'
str += '								</div>'
str += '							</div>'
str += '						</li>'
...
str += '														<li><a href="historyAwards.html">연혁</a></li>'
str += '														<li><a href="map.html">오시는 길</a></li>'
str += '													</ul>'
str += '												</li>'
str += '											</ul>'
str += '										</li>'
...
str += '									<dl>'
str += '										<dt>회사소개</dt>'
str += '										<dd>SK인포섹 소개, <br>CEO인사말, 인재상, 채용 정보 <br>등을 확인할 수 있습니다.</dd>'
str += '									</dl>'
str += '								</div>'
str += '							</div>'
str += '						</li> '                        
...
str += '									<dl>'
str += '										<dt>News Room</dt>'
str += '										<dd>SK인포섹이 제공하는 <br>보안 관련 자료를 <br>확인할 수 있습니다.</dd>'
str += '									</dl>'
str += '								</div>'
str += '							</div>'
str += '						</li>'
str += '						<li class="last">'
str += '							<a href="/customer/consultView.vw"><span>블로그</span></a>'
str += '							<div class="sub_menu">'
str += '								<div class="inner">'
str += '									<ul>'
str += '										<li>'
...
str += '									<dl>'
str += '										<dt>블로그</dt>'
str += '										<dd>SK 인포섹의 다양한 이야기를 <br>한눈에 확인할 수 있습니다.</dd>'
str += '									</dl>'
str += '								</div>'
str += '							</div>'
str += '						</li>'
